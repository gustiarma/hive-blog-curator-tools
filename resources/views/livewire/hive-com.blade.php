<div>
  ...
  <div
    ...
    <div class="flex h-15  sm:w-full  md:w-1/3 ">
      <button data-action="increment"
        ...
        <span class="m-auto text-2xl font-thin" wire:click="loadMore">Load More</span>
      </button>
    </div>
  ...
  <ul class="bg-dark grid grid-cols-1 gap-2 sm:grid-cols-2 md:grid-cols-2">
    @forelse ($communityPosts as $item)
  ...
  @if (count($communityPosts) > 0)
    ...
    <div class="container flex items-center pt-5 pb-5">
